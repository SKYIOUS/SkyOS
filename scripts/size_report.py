...
PATHS = [
    ("Kernel (debug)", "../SKYIOUS KERNEL/kernel/target/x86_64-unknown-none/debug/vahi_kernel"),
    ("Kernel (release)", "../SKYIOUS KERNEL/kernel/target/x86_64-unknown-none/release/vahi_kernel"),
    ("Bootimage (debug)", "../SKYIOUS KERNEL/target/x86_64-vahi/debug/bootimage-vahi_kernel.bin"),
    ("Bootimage (release)", "../SKYIOUS KERNEL/target/x86_64-vahi/release/bootimage-vahi_kernel.bin"),
