...
pub(crate) fn test_window_creation(desktop: &mut Desktop) -> bool {
    ...
    let win = AppWindow {
        ...
        prev_x: 100, prev_y: 100, prev_w: 400, prev_h: 300,
        title: String::from("TestWin"),
        content: alloc::vec::Vec::new(), scroll: 0, id: 0, pid: None,
...
pub(crate) fn test_window_focus(desktop: &mut Desktop) -> bool {
    ...
    let win_a = AppWindow {
        ...
        prev_x: 50, prev_y: 50, prev_w: 300, prev_h: 200,
        title: String::from("FocusA"), content: alloc::vec::Vec::new(),
    ...
    let win_b = AppWindow {
        ...
        title: String::from("FocusB"), content: alloc::vec::Vec::new(),
