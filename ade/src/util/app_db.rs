...
pub(crate) static APPS: &[AppEntry] = &[
    ...
    AppEntry {
        ...
        cat: AppCategory::System,
        exec: "",
        desc: "About the operating system",
        icon: 'A',
    },
    // Network
    AppEntry {
